...
class FileUtil{
    ...
    async saveDateFiles(type, requestMap){
        ...
        let dateSplit = [ new Date().getFullYear(), month.length > 1 ? month + 1 : '0' + (month + 1) ];
    ...
    parseName(number){
        ...
        switch(number){
            case 'imgThumbTemp_1': name = 'boardImgTempPath'; break;
            case 'imgFile_1' : name = 'boardImgFilePath'; break;
            case 'imgFileThumb_1' : name = 'boardImgFileThumbPath'; break;
            case 'imgFileThumbUrl_1' : name = 'boardImgFileThumbUrl'; break;
            default : break;
        }
